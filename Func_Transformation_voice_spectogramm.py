...
def generate_spectogram(voice):
    ...
    voice = voice.split('/')[-1]
    print('lll')
    fig.savefig("C:/Users/yanaz/Documents/Yana s things/программирование/Анализ данных/ААКодVoice/venv/spectogramm/spect.png")

    plt.clf()

generate_spectogram('venv/predict_trial_voice/Female_1.flac')
